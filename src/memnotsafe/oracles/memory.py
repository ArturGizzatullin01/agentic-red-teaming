"""src/memnotsafe/oracles/memory.py — MemoryOracle: candidate memory exists
...
from memnotsafe.oracles.base import EvaluationContext, find_candidate_record, unknown
