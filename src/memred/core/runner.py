"""src/memred/core/runner.py — единственное место, где склеены target/attack/oracles/
...
from memred.adapters.base import Capabilities, TargetAdapter
from memred.attacks.base import AttackBase, AttackContext
from memred.core.models import AttackResult, StageResult
from memred.evidence.diff import SnapshotDiff, compute_diff
from memred.evidence.snapshot import SystemSnapshot
from memred.oracles.base import EvaluationContext
from memred.oracles.composite import composite_success, evaluate_all
