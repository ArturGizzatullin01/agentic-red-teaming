"""src/memred/core/models.py — типизированные модели, которыми обмениваются все компоненты.
...
(src/memred/tracing/events.py) и сырые ответы адаптеров, потому что они
