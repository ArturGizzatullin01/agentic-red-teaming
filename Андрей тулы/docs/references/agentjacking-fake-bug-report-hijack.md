...
> Источник (сконвертировано из HTML): One Fake Bug Report Hijacked a $250B Company’s AI Agent.html
...
| Enterprise software & cloud (Fortune 500) | ~$250B parent | Claude Code on two corporate Windows devices confirmed existing: Cloud infra tokens, git tokens, etc. | 
...
Want a walkthrough of what this looks like in your environment? **Contact us**
