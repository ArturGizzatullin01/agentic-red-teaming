"""memred/oracles/adoption.py — AdoptionOracle (spec §13): retrieved memory ->
...
недоступен для данного `expected_effect["type"]` — спек явно требует, чтобы
судья не решал весь verdict сам и возвращал structured JSON (см. spec §28);
